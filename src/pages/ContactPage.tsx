...
const WEB3FORMS_ACCESS_KEY = import.meta.env.VITE_WEB3FORMS_ACCESS_KEY || "9af2abb9-1185-449c-9df9-320ba94e8808";
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!cleanName || !cleanEmail || !cleanMessage) {
      setSubmitError("Please provide your name, a valid email address, and a brief project description.");
      return;
    }
    ...
    try {
      ...
      if (result.success) {
        ...
        setSubmitError(result.message || "Message could not be sent. Please try again or reach out directly via email.");
      }
    } catch {
      setSubmitError("Message could not be sent due to a temporary network interruption. Please try again or email malekfazilkhan07@gmail.com directly.");
    } finally {
  ...
  return (
    <div className="py-24 px-6 md:px-10 max-w-7xl mx-auto">
      ...
      <div className="grid lg:grid-cols-12 gap-12 items-start">
        <div className="lg:col-span-7 reveal wiggle-box bg-[#fffef7] p-8 md:p-10 border-[2.5px] border-black rounded-lg relative shadow-[6px_8px_0_rgba(26,26,26,0.12)]">
          ...
          {submitted ? (
            <div className="bg-green-100 border-2 border-green-500 p-8 rounded-md text-center space-y-4 font-[Kalam]">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {rateLimitError && (
                <div className="p-3 bg-red-100 border border-red-400 text-red-700 rounded-md text-sm font-[Kalam]">
                  ⏳ Please wait a few seconds before submitting another request.
                </div>
              )}

              {submitError && (
                <div className="p-3 bg-red-50 border-2 border-red-400 text-red-800 rounded-md text-sm font-[Kalam]">
                  ⚠️ {submitError}
                </div>
              )}
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full p-3 border-2 border-black rounded-md font-[Patrick_Hand] text-lg bg-white focus:outline-none focus:ring-2 focus:ring-[#e63946]"
                  />
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  className="w-full p-3 border-2 border-black rounded-md font-[Kalam] text-base bg-white focus:outline-none focus:ring-2 focus:ring-[#e63946]"
                />
              </div>
        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="reveal sketch-card !p-6 relative">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a
                ...
                className="btn-hand btn-red !py-2 !px-4 !text-sm"
              >
                📞 Call Me
              </a>
            </div>
          ...
          <div className="reveal wiggle-box bg-[#fffdf5] p-6 border-2 border-black rounded-lg shadow-[4px_5px_0_rgba(26,26,26,0.1)]">
            ...
            <div className="space-y-3">
              {socialLinks.map((s) => (
                <a
                  ...
                  className="flex items-center justify-between p-3 bg-white border-2 border-black rounded-md hover:bg-[#fff9b0] transition-colors"
                >
